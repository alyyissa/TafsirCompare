    ...
    <main className="min-h-screen pt-32 pb-20 bg-slate-50">
      <div className="px-3 sm:px-4 md:px-11 lg:px-13 xl:px-12 2xl:px-16 mb-16">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-end justify-between gap-8">
          ...
          <div className="flex w-full items-center border pl-4 gap-2 bg-white border-primary/20 h-[52px] rounded-full overflow-hidden max-w-md shadow-sm focus-within:border-primary focus-within:shadow-md transition-all">
